...
classname = "Public Cloud Architectures: Deploying F5 BIG-IP Virtual Edition on Google Cloud Platform"

# OPTIONAL: The URL to the GitHub Repository for this class
github_repo = "https://github.com/TonyMarfil/f5-agility-labs-f5-in-gcp-1"
